...
import 'package:clean_arch/presentation/cep/cubit/cep_state.dart';
...
import 'package:clean_arch/presentation/ramoatividade/widgets/novo_ramo_atividade_widget.dart';
...
import 'package:clean_arch/presentation/tipotelefone/widgets/novo_tipo_telefone_widget.dart';
import 'package:clean_arch/presentation/ramoatividade/widgets/ramo_atividade_dropdown_widget.dart';
import 'package:clean_arch/presentation/cliente/cliente_form/widgets/selecionar_foto_cliente_widget.dart';
import 'package:clean_arch/presentation/tipotelefone/widgets/tipo_telefone_dropdown_widget.dart';
...
class _ClienteCadastroPageState extends State<ClienteCadastroPage> {
  ...
  final cubitRamoAtividade = getIt<RamoAtividadeCubit>();
  ...
  void initState() {
    ...
    telefoneSubscription = cubitTipoTelefone.stream.listen((state) {
      if (state is TipoTelefoneSucess) {
